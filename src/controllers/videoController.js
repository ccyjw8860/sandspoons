...
export const watch = async (req, res) => {
  ...
  const video = await Video.findById(id).populate("comments.commentor");
  if (video) {
...
export const testController = async (req, res) => {
  ...
  //   {
  //     likes: 0,
  //     _id: "60dc24c20c283a3bf1ad54d8",
  //     commentor: "60dc24bd0c283a3bf1ad54d1",
  //     context: "first comment!",
  //   },
  // ];
  const id = "60dc24bd0c283a3bf1ad54d1";
  const video = await Video.findById(id);
  res.render("test", { pageTitle: "TEST CODE!", video });
};
